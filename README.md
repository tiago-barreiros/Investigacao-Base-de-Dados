...
# Base de Dados (SQL Server, MySQL, PostgreSQL, SQLite)

<table>
<tr>
<td>

> Investigação representada e desenvolvida em 10 semanas diferentes.
...
Após a entrega deste projeto ficará publico :  https://github.com/tiago-barreiros/Investigacao-Base-de-Dados
...
> Documentação encontra-se em bruto modo nas Notas de Apoio às Aulas Teóricas e Práticas.
...
## [Prof. Doutor João Muranho](https://www.researchgate.net/profile/Joao-Muranho)

## *Base de Dados* @[Universidade da Beira Interior](https://www.ubi.pt/).
